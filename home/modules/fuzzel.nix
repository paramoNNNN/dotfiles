{
  ...
  xdg.configFile = {
    ...
    # https://wimpysworld.com/posts/fuzzel-hyprpicker/
    "fuzzel/colorpicker.sh".text = ''
      #!/usr/bin/env bash
      # A tool to pick colors from the screen using hyprpicker and fuzzel

      set +u # Disable nounset
      APP_NAME="fuzzel-hyprpicker"
      NOTIFY="notify-send --app-name=$APP_NAME --icon=org.gnome.design.Palette"
